...
public class MainPreferencesActivity extends BasePreferencesActivity {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        if (position == aboutExteraRow) {
            ...
            Browser.openUrl(getParentActivity(), "https://github.com/Overgram/Overgram4A");
        } else if (position == channelRow) {
            MessagesController.getInstance(currentAccount).openByUserName(("overgram1338"), this, 1);
        } else if (position == groupRow) {
            MessagesController.getInstance(currentAccount).openByUserName(("overgramchat"), this, 1);
        } else if (position == crowdinRow) {
            Browser.openUrl(getParentActivity(), "https://crowdin.com/project/overgram");
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (position == generalRow) {
                        ...
                        textCell.setTextAndValueAndIcon(LocaleController.getString("Channel", R.string.Channel), "@overgram1338", R.drawable.msg_channel, true);
                    } else if (position == groupRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("SearchAllChatsShort", R.string.SearchAllChatsShort), "@overgramchat", R.drawable.msg_groups, true);
                    } else if (position == crowdinRow) {
