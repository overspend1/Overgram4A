...
public class OverUtils {
    ...
    public static String getFilename(TLObject obj, File attachPathFile) {
        ...
        var f = OverUtils.removeExtension(filename);
        ...
        f += "@" + OverUtils.generateRandomString(6);
        f += OverUtils.getExtension(filename);

        return f;
    }

    public static String getReadableFilename(String name) {
        var ext = OverUtils.getExtension(name);
    ...
    public static Pair<Integer, Integer> extractImageSizeFromName(String name) {
        ...
        try {
            ...
            Log.d("Overgram", "extractImageSizeFromName fucked", e);
            return null;
        }
    }
    ...
    public static Pair<Integer, Integer> extractImageSizeFromFile(String path) {
        try {
            ...
            Log.d("Overgram", "extractImageSizeFromFile fucked", e);
            return null;
        }
    }
