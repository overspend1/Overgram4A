...
public class NotificationsService extends Service {
    ...
    public void onCreate() {
        ...
        if (OverConfig.keepAliveService && Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String CHANNEL_ID = "overgram_push";
            ...
            try {
                ...
                Log.e("Overgram", "Xiaomi moment", e);
